...
const cache_1 = __importDefault(require("./api/cache"));
...
const processManager_1 = __importDefault(require("./api/processManager"));
...
function startAPIServer(randomSecret) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            ...
            httpServer.use("/api/cache", cache_1.default);
            ...
            httpServer.use("/api/process-manager", processManager_1.default);
